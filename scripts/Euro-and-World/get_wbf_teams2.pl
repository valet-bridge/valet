...
my $output_file = "wteams2.txt"; # Is appended
my $output_bak = "wpteams2.bak";
...
my $number_file = 'database/names/wbf/manual/teams2.txt';
...
sub get_team
{
  ...
  for my $row (@rows)
  {
    ...
    my $name = $tds[0]->as_text;

    my $function = $tds[1]->as_text;
