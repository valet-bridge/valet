...
(
  ...
  { START => 14213, END => 14222, TEXT => 'CBF',
    CORR => 'CBC' },
  { START => 14226, END => 14275, TEXT => 'Budimex [GM]PP',
  ...
  { START => 21520, END => 21544, TEXT => 'Grand Prix of Poland',
    CORR => 'Grand Prix of Poland Pairs' },
  ...
  { START => 29185, END => 29191, TEXT => 'Grand Prix of Poland',
    CORR => 'Grand Prix of Poland Pairs' },
  { START => 29191, END => 29213, TEXT => 'Grand Prix of Poland',
    CORR => 'Grand Prix of Poland Teams' },
  { START => 29546, END => 29552, TEXT => 'GP of Poland',
    CORR => 'Grand Prix of Poland Pairs' },
