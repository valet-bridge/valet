...
(
  ...
  Bulgaria => ['asenovec', 'asenovgrad', 'balchik', 'chepelare',
    'dimitrovgrad', 'dobrich', 'kesten', 'kyustendil', 'la marina', 
    'pelotas', 'pernik', 'pleven', 'plovdiv', 'popovo', 'shumen', 
    'sofia', 'stara zagora', 'varna', 'vraca', 'yambol'],
...
(
  ...
  Greece => ['Tzilis'],
  'Hong Kong' => ['AIA', 'Hong Kong Vico', 'JP Morgan',
    'Phoenix TV', 'Wellwise'],
  ...
  India => ['Accenture', 'Andromeda Baroda', 'APRA Clothing', 'Avia',
    ...
    'Taste of Goa', 'Team Secure', 'Tekser', 'Tolani Shipping Ltd', 
    'Trambak Rubber', 'Tricon Infotech', 'TTK Healthcare', 'TVS Tread', 
    'UTI Bank', 'Wellknit'],
