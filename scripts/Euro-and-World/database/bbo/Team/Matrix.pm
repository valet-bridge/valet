...
(
  ...
  Peru => ['ayacucho', 'lima'],
  Poland => ['boleslawiec', 'chelmno', 'elblag', 'gdansk', 'gdynia', 
    'gniezno', 'gorzow', 'kalisz', 'katowice', 'kielce', 'kornik', 
    'krakow', 'leszno', 'lodz', 'lojdy', 'lowicz', 'lublin', 'olsztyn', 
    'poznan', 'pulawy', 'rzeszow', 'silesia gliwice', 'skawina', 
    'slawa', 'solot', 'szczyrk', 'tarnów', 'warsaw', 'wisla', 
    'wroclaw', 'wronie', 'zyrardow'],
