...
(
  ...
  Poland => ['boleslawiec', 'bydgoszcz', 'chelmno', 'elblag', 'gdansk', 
    ...
    'skawina', 'slawa', 'solot', 'szczyrk', 'tarnów', 'warsaw', 
...
(
  ...
  India => ['Accenture', 'Andromeda Baroda', 'APRA Clothing', 'Avia',
    ...
    'Indian Medical', 'Indian Oil', 'Indian Railways', 'Interkala', 
    'Jain Group', 'Kaushik Hyderabad', 'KH Power', "Kini's Bangalore", 
    "Kini's Goa", 'Kosmos Delhi', 'Manyavar', 'Mayur Renergy', 
    'NALCO', 'Navachaitanya', 'Navayuga', 'Nest Inn', 'OCI Copper', 
