...
(
  ...
  India => [
    ...
    'kanpur', 'kashi', 'kolkata', 'kota', 'mitra vihar', 'mumbai', 
    'nagpur', 'nashik', 'pune', 'puri', 'sukma', 'udaipur'],
  Indonesia => [ 
...
(
  ...
  China => ['Beibao', 'Beidike', 'Beijing Capital', 'Beijing Cartoon', 
    ...
    'Chinese Hailian', 'Chuanmei', 'Dalian Dichan', 'Datang', 'Dian Zi Cheng', 
    'Dianwang', 'Dongfeng', 'Dongfang Tairong', 'Fanhua Jituan',
    'Geely Automobile', 'Gong Hang Jin Ying', 
    ...
    'Hainan Window', 'Hangzhou Jingjiang', 'Heilongjiang Tea',
    'Heng Yuan Xiang', 'Hengsha Haijiu', 'Hengsha Ke Ji', 'Hong Zhu',
    'Hongyu', 'Huachu', 'Huangshi Qixing', 'Huayuan', 'Hubei Dongfeng',
    'Hubei Yihua', 'Hunan Tou Zhan', 'Jiang You', 'Jilin Dingyuan',
    'Jin Rong', 'Jin Jing', 'Jinfan', 'Jing Tie', 'Lianbo', 
    'Lianzhong Shi Jie', 'Lu Cheng', 'Lu Ning Coal', 'Mai Zi Fu Shi',
    'Mei Kuang', 'Meilin Qing Cheng', 'Nanfang Dianwang', 
    'Nanguang Power', 'Nanning Yalun', 'Nanyuan', 'Nong Fa Hang', 
    'PD Real Estate', 'PD Times', 'PD Transnational', 
    'Pan China Construction', 'Qiaoyou', 'Qingnian Qiche', 
    'Sanya Jiguan', 'Sanya Tianze', 'Shan Hai', 'Shanghai Automobile', 
    'Shanghai Financial', 'Shanghai Gaohe', 'Shanghai Jiahua', 
    'Shanghai Ling Mu', 'Shanghai Municipal Engineering Group', 
    'Shanghai Qiche', 'Shanghai Qihao', 'Shanghai Qi Zhong', 
    'Shanghai Weiyu', 'Shanghai Zhongfu', 'Shanxi Luning', 
    'Shanxi Qinlian', 'Shen Jiu', 'Sheng Tao Sha', 'Sheng Yu Tian', 
    'Sheng Yuan', 'Shenzhen Electronic City', 'Shenzhen Lanpu', 
    'Shenzhen Nangang', 'Shenzhen Ping An', 'Shenzhen Qiayao', 
    'Shenzhen Topone Car', 'Shi He Dong Li', 'Shi You', 'Shichuang', 
    'Shiji Changda', 'Shouchuang', 'Sichuan Dahe', 'Sunchime Cartoon', 
    'Sunchime Fund', 'Sung Tao', 'Suzhou Youtong', 'SY Sheng Yutain', 
    'Tielu Jixie', 'Tsingtao', 'Wuhan Dongfang', 'Xiamen Xiashun', 
    'Xiao Ying', 'Yalu Group', 'Yibin China Resources', 'Yi Tong', 
    'Yuetao', 'Yufeng Electric', 'Yunnan Dikuang Resources', 
  ...
  Estonia => ['Baltic Express'],
  France => ['BridgePlus'],
  Germany => ['Allianz'],
  Iceland => ['101 Fasteignasala', 'Actavis'],
  India => ['Accenture', 'Andromeda Baroda', 'APRA Clothing', 'Bajaj', 
    'Bangur Cement', 'Baroda Bank'],
  'Hong Kong' => ['AIA', 'Hong Kong Vico', 'Phoenix TV', 'Wellwise'],
  Iceland => ['Breki Jarðverk', 'Bridgefélag Reykjavíkur',
    'Bústólpi ehf', 'Ferðaskrifstofa Vesturlands', 'Garðar & Vélar',
    'Garðs Apotek', 'HF Verðbréf', 'Hreint ehf', 'Iceland Express',
    'Lögfræðiskrifstofa Islands', 'Lögfræðistofa Bjarna', 'Málning hf',
    'Morgunblaðið', 'Ráðgjöf', 'Sölufélag Garðyrkjumanna',
    'Sparisjóður', 'Sparisjóður Keflavik', 'Sparisjóður Norðfjörður',
    'Sparisjóður Siglufjarðar', 'VBS Fjárfestingarbanki hf.',
    'Vidbot ehf', 'Tryggingamiðstöðin'],
