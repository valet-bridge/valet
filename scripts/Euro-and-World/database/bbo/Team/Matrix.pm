...
(
  ...
  India => [
    ...
    'kota', 'madras', 'mitra vihar', 'mumbai', 'nagpur', 'nashik', 
    'pune', 'puri', 'sukma', 'udaipur', 'varanasi'],
  Indonesia => [ 
  ...
  Poland => ['boleslawiec', 'chelmno', 'elblag', 'gdansk', 'gdynia', 
    ...
    'krakow', 'leszno', 'lodz', 'lowicz', 'lublin', 'olsztyn', 
    'poznan', 'rzeszow', 'silesia gliwice', 'skawina', 'solot', 
...
(
  ...
  Netherlands => ['Aquatrans', 'Arboned', 'Continental',
    'ING Bank', 'Melchemie', 'Modalfa', 'Ravebo', 'VVE Beheer'],
  Norway => ['ABAX', 'Advisor Revisjon Norge', 'Astro A/S',
    'Bridge i Norge', 'Bridgemagasiner.no', 'FX Securities',
    'konkurs.no', 'Nortemp', 'Polarman Regnskap', 'Tannlege Kvaran', 
    'Viego Regnskap'],
