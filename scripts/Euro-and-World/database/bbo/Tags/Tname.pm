...
(
  ...
  'Vest-Agder Team Championship' => ['vest-agder km lag', 'vest-agder'],
...
(
  ...
  'Ruia Gold Cup' => ['ruiagold'],
  'Ruia Silver Cup' => ['ruiasilver'],
  'Ruia Trophy' => ['ruia'],
  'Scottish Cup' => ['scottishcupplate'],
  'Serdika Cup' => ['serdikacup'],
  ...
  'Vest-Agder Team Championship' => ['vakm'],
