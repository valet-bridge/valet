...
(
  ...
  'Australian Open Trials' => ['australian open team trials'],
  ...
  'Forbo Krommenie Teams' => ['forbo-krommenie tournament',
  ...
  'Greek Open Trials' => ['greek trials'],
  ...
  'Indian Senior Trials' => ['indian senior team selection trials'],
  'Indonesian Inter-Club Championship' => [
