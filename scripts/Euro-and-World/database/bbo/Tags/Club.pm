...
(
  ...
  'BC München' => ['munchen i', 'bc münchen e.v.'],
  ...
  'Dauna Winazza' => ['dauna winaza',
    'daunna winazza', 'dauna winazaa'],
  ...
  'Sinan Folklor Juniors SK' => ['ahi sinan fagsk'],
