...
(
  ...
  'Baþkent Sekans BSK' => ['baskent sekans', 
    'baskent sekans bric'],
  'BASEK BK' => ['basek bric'],
  ...
  "BC de la Côte d'Amour" => ["BC dela Côte d'Amour"],
  ...
  '7 Eylül SK' => ['7 eylul genclik sk', '7 eylul'],
  'Fakultas Teknik Bridge Club Universitas Tanjungpura' =>
