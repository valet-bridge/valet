...
(
  ...
  'Anka BK' => ['anka bric', 'anka bskd'],
  'Ankara RBB' => ['ankara rbb club', 'ankara rrb club',
    'ankara ruzgari'],
  ...
  'Atakoy BSK' => ['Atakoy Bric SK', 'Atakoy BK', 'Ataköy BSKD',
    'Atakoy BSKD'],
  ...
  'AZS Wratislawia' => ['asz wratislavia', 'azs wratilavia'],
  'Babaeski BSK' => ['babaeskispor bsk'],
  'Bahcesehir Club' => ['Bahçeþehýr Brýç'],
  ...
  'Çayyolu BK' => ['cayyolu bk', 'Çayyolu Briç SKD', 'Çayyolu BSK',
    'Cayyolu Briç SKD', 'Cayyolu Bridge Club', 'Cayyolu BSK',
    'Cayyolu BC'],
  ...
  '7 Eylül SK' => ['7 eylul genclik sk', '7 eylul', '7 eylül bsk'],
  'Fakultas Teknik Bridge Club Universitas Tanjungpura' =>
  ...
  'Kadirli Akil Oyunlari Merkezi' => ['kaom yildizlar'],
  'Kapakli Sýte' => [
    'kapaklý sýte',
    'kapakli site',
    'kapakli site bsk',
  ...
  'Kirklarelý BSK' => [
    ...
    'kirklareli bld. sp',
    'kirklareli gsk'],
  'Kocaeli BSSK' => ['Kocaelý BSSK', 'Kocaeli SK'],
  ...
  'Luleburgaz SK' => ['luleburgaz kul. san', 'luleburgaz kul.san'],
  ...
  'MBC Kinali' => ['minahasa bridge club kinali'],
   'Mersin Club' => ['mersin bsb', 'mersin bþb', 'mersin bsbs',
     'mersin bsk', 'mersin ybsk', 'mersin bbs', 'mersin bsb sk', 
     'mersin bb', 'mersin b.b.k', 'mersin b.b.s', 'mersin b.s.b',
     'mersin b.s.b. s.k', 'Mersýn BBSK', 'Mersýn B.S.B. S.K'],
  ...
  'Narlidere Club' => ['narlidere ihtisas'],
  'Nazilli BBSK' => [
    'nazilli bsk',
    'nazilli skd',
    'nazýllý bsk'],
...
(
  ...
  'Istanbul Sports' => ['istanbulspor', 'ýbsk', 'ýbmsk', 'istanbulskd'],
