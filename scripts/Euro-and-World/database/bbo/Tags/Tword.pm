...
(
  ...
  Championship => ['campionship', 'champ', 'champion', 'champions', 
    ...
    'chamions', 'chamionship', 'chammp', 'cham',
  ...
  National => ['natioanl', 'nationale', 'nationals', 'natonale',
    'natinal', 'nationald', 'naational', 'nacional', 'nasional', 'nat'],
