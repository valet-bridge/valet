...
(
  ...
  'Division Nationale' => ['division natonale', 'division ntionale',
    ...
    'france div_ nat_ 1', 'div_ nat_', 'division nationale1',
  ...
  'Mixed Teams' => ['du 4 mixte', 'mixed/4', '4 mixte', 'mixte/4'],
  ...
  'Super League' => ['sup league', 'super legue', 'sup leg', 'sup l',
...
(
  ...
  Championship => ['campionship', 'champ', 'champion', 'champions', 
    ...
    'championnat', 'þampýyonasi', 'champio',
