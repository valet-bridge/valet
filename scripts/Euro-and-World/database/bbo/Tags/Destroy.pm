...
(
  ...
  'Empty Words' => ['Around 52 cards in 80 years',
    ...
    'last train', 'main event', 'match retour', 'no name', 'pour pau',
...
(
  ...
  Uninformative => ['?',
    ...
    'dist', 'duplicate', 'duplicato', 'dup',
    'earth', 'eagles', 'east', 'elite', 'étoile', 
    'fans', 'hawks', 'home', 'host',
    'inter', 'interland',
    'leaders', 'leders', 
    'man', 'merkezi', 'mates', 'milli', 'missed', 'multievent', 
    'multieventof',
    ...
    'united', 'untitled', 'us', 'various', 'vg', 'vmg',
