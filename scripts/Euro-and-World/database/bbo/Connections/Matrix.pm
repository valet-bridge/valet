...
(
  ...
  Denmark => [
    ...
    'slagelse', 'søborg', 'vejle', 'åkirkeby', 'århus'],
  Ecuador => ['guayaquil'],
  ...
  France => [
    ...
    'massy', 'montpellier', 'nancy', 'nice', 'paris', 'reims', 
  ...
  Indonesia => [ 
    ...
    'sidoarjo', 'sleman', 'solok', 'sukomoro', 'surabaya', 'tambun',
  ...
  Norway => [
    ...
    'flekkefjord', 'førde', 'gudbrandsdal', 'gjøvik og vardal', 
  ...
  Sweden => [
    ...
    'skara', 'snåsa', 'täby', 'täfteå', 'tofta', 'uppsala', 'varberg', 
  ...
  Taiwan => ['changhua', 'chiayi', 'hsinchu', 'jiangyou', 'kaohsiung',
    'keelung', 'miaoli', 'taichung', 'tainan', 'taipei city', 
    'new taipei city'],
