...
(
  ...
  Indonesia => [ 
    ...
    'banjarmasin', 'batam', 'batu', 'bengkulu', 'bitung', 
  ...
  Russia => ['lokotok', 'moscow', 'saint petersburg'],
...
(
  ...
  Jakarta => ['Gabrial University of Indonesia', 'Jakarta BBG', 
    'Laksamana', 'Pelatnas', 'Siwo Persatuan Wartawan Indonesia',
  ...
  Rome => ['Tennis Club Parioli', 'Star Bridge Roma', 'NBI roma',
    'ASD Tennis Roma'],
