...
(
  ...
  Indonesia => [ 
    ...
    'depok', 'gresik', 'hatay', 'jakarta', 'jember', 'karimun', 
    'kediri',
    'kedungwaru', 'klabat', 'kota bandung', 'kota bekasi', 'kota bogor', 
  ...
  Turkey => ['adalar', 'adana', 'adapazan', 'akhisar', 'aladag', 'ankara', 
    ...
    'söke', 'tekýrdag', 'tire', 'tonya', 'usak', 'van', 
...
(
  ...
  Beijing => ['Beijing Baxi Football', 'Hua Yuan Club', 'SPG Club'],
  Beirut => ['Hamra Club'],
  ...
  Istanbul => ['ABK', 'Altinay SK', 'Atakoy BSK', 'Atletik Basket', 
    'Avrasya SK', 'Bakýrköy Briç SK', 'Besiktas', 'Bogazici BSK', 
    'Camlica Sports', 'Fatih Karagümrük SK', 'Fenerbahce', 'Galata', 
    'Galatasaray', 'Göktürk SK', 'Heybeliada SK', 'Hosgoru', 
    'Istanbul Sports', 'Kartal Club', 'Kocamustafapasa SK', 
    'Kucukcekmece BK', 'Majör Boğaziçi', 'Major Hosgoru', 
    'Sancaktar GSK', 'Slem Bric SK', 'Vefa SK'], 
  Izmir => ['Altay Genclik', 'Arkas SK', 'Bornova BSK', 'Buca Sports',
    'Goztepe Hilal SK', 'Izmir BSB', 'Sirinyer Sports', 'Ege Club',
    'Karsiyaka BSK', 'Narlidere Club', 'Cimentas Club', 'Konak Club'],
...
(
  ...
  Turkey => ['Akaylar', 'Alfa Romeo', 'Aliaga Kyme', 'Altinay',
    ...
    'Gözgöz', 'GSD', 'IBM', 'Inci Ayakkabi', 'Kare Dam', 'Magpa-Grup',
