...
(
  ...
  Italy => [
    ...
    'reggio calabria', 'reggio emilia', 'rimini', 'rome', 'salerno', 
    'san giorgio del sannio', 'senigallia', 'siena', 'torino', 
    'trieste', 'varese', 'venice', 'verona', 'villa fabbriche'],
  ...
  Netherlands => ['amsterdam', 'delft', 'enschede', 'groningen',
    'leiden', 'maastricht', 'nijmegen', 'the hague', 'utrecht'],
  ...
  Turkey => ['adalar', 'adana', 'adapazan', 'akhisar', 'ankara', 
...
(
  ...
  Istanbul => ['Altinay SK', 'Atletik Basket', 'Bakýrköy Briç SK',
    'Besiktas', 'Bogazici BSK', 'Camlica Sports', 'Fatih Karagumruk', 
    'Fenerbahce', 'Galata', 'Galatasaray', 'Göktürk SK', 'Heybeliada SK', 
    'Hosgoru', 'Istanbul Sports', 'Karagümrük', 'Major Hosgoru', 
    'Majör Boğaziçi', 'Pamukspor', 'Slem Bric SK', 'Vefa SK'],
  Izmir => ['Altay Genclik', 'Bornova BSK', 'Buca Sports',
    'Goztepe Hilal SK', 'Izmir BSB', 'Sirinyer Sports'],
  ...
  Trieste => ['bc trieste'],
  Tromsø => ['Tromsø BK'],
  Trondheim => ['Studentenes BK', 'Heimdal BC'],
