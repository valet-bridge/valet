...
(
  ...
  Norway => ['agder', 'buskerud', 'haugaland', 'hedmark', 
...
(
  ...
  Hungary => ['balaton', 'balatonföldvár', 'budapest', 'debrecen',
    'gyor', 'nagykanizsa', 'pecs', 'siofok', 'szeged'],
  Iceland => ['reykjavik'],
  India => ['agresar',
    ...
    'kolkata', 'kota', 'madras', 'mardin', 'mitra vihar', 'mulund', 
  ...
  Poland => ['bielsko-biala', 'boleslawiec', 'bydgoszcz', 'bytom', 
    ...
    'olsztyn', 'poznan', 'pulawy', 'rzeszow', 'silesia gliwice', 
    'skawina', 'slawa', 'sopot', 'szczyrk', 'tarnów', 'warsaw', 
  ...
  Turkey => ['adana', 'adapazan', 'akhisar', 'ankara', 'antalya', 
    'atakum', 'aydin', 'ayvalik', 
    ...
    'mersin', 'midyat', 'milas', 'muðla', 'nazilli', 
    'orhangazi', 'pamukkala', 'samsun', 'seferihisar', 'sivas', 
    'söke', 'tekýrdag', 'tire', 'tonya', 'usak', 'van', 
    'yarýmca', 'yatagan', 'yedi eylul', 'yildirim'],
  Ukraine => ['kiev'],
...
(
  ...
  Mumbai => ['ABA Mumbai', 'Matunga', 'Otters Club', 
    'The West End Mumbai', 'WCG Mumbai'],
