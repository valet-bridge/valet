...
(
  ...
  Bulgaria => ['asenovec', 'asenovgrad', 'balchik', 'chepelare',
    ...
    'preslav', 'shumen', 'sofia', 'stara zagora', 'varna', 'vraca', 
    'yambol'],
  Canada => ['vancouver'],
...
(
  ...
  Istanbul => ['ABK', 'Altinay SK', 'Atakoy BSK', 'Atletik Basket', 
    'Bakýrköy Briç SK', 'Besiktas', 'Bogazici BSK', 'Camlica Sports', 
    'Fatih Karagümrük SK', 'Fenerbahce', 'Galata', 'Galatasaray', 
    'Göktürk SK', 'Heybeliada SK', 'Hosgoru', 'Istanbul Sports', 
    'Kartal Club', 'Major Hosgoru', 'Majör Boğaziçi', 
    'Sancaktar GSK', 'Slem Bric SK', 'Vefa SK', 
    'Kocamustafapasa SK', 'Kucukcekmece BK'],
  ...
  Lisbon => ['Armando and Viviane Gonçalves Pereira',
    'Benfica', 'Núcleo De Bridge Do Círculo', 'Sporting Lisbon'],
  Lodi => ['Fanfulla'],
  Lom => ['Øvre Ottadalen'],
