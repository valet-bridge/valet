...
(
  ...
  Istanbul => ['atakoy', 'bahce', 'bahcesehir', 'bayrampaþa',
    ...
    'kocamustafapasa', 'kucukcekmece', 'pasham', 'polonezkoy',
    'suralaya', 'taskopru'],
...
(
  ...
  Istanbul => ['ABK', 'Altinay SK', 'Atakoy BSK', 'Atletik Basket', 
    ...
    'Fatih Karagumruk', 'Fenerbahce', 'Galata', 'Galatasaray', 
    'Göktürk SK', 'Heybeliada SK', 'Hosgoru', 'Istanbul Sports', 
    'Karagümrük', 'Kartal Club', 'Major Hosgoru', 'Majör Boğaziçi', 
    'Slem Bric SK', 'Vefa SK', 'Kocamustafapasa SK', 'Kucukcekmece BK'],
