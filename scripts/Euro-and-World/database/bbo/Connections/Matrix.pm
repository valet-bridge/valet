...
(
  ...
  China => [
    ...
    'jinchang', 'jincheng', 'jinjiang', 'jiujiang', 'jixiexiang', 
    'kunshan', 'lanzhou', 'liushu', 'meilin qingcheng', 'nanchang', 
    'nanchong', 'nanning', 'ningbo', 'panzhihua', 'qingdao', 'sanya', 
    'shanghai', 'shaoguan', 'shenyang', 'shenzhen', 'shijiazhuang', 
    'suzhou', 'taicang', 'taihu lake', 'taizhou', 'tianjin', 'wuhan', 
    'wuxi', 'xin zhu', 'xiamen', 'xian', 'xiantao', 'xinyi', 'yanshi', 
    'yizhuang', 'yuquan', 'zhaoqing', 'zhong jian', 'zhongshan', 
    'zhuzhou', 'zigong'],
  ...
  Denmark => [
    ...
    'odense', 'ravnkilde', 'rødovre', 'slagelse', 'stoholm', 'svendborg', 
    'søborg', 'vejle', 'åkirkeby', 'århus'],
  Ecuador => ['guayaquil'],
  ...
  Germany => ['aachen', 'augsburg', 'bad griesbach', 'bamberg', 'berlin', 
    'bielefeld', 'bonn', 'bremen', 'burghausen', 'darmstadt', 'düsseldorf', 
    'essen', 'frankfurt', 'hamburg', 'hannover', 'heikendorf', 'karlsruhe', 
    'kassel', 'ketsch', 'kiel', 'köln', 'leverkusen', 'mannheim', 'munich', 
    'niedernhausen', 'nürnberg', 'oldenburg', 'potsdam', 'rieneck', 
    'saarbrücken', 'schwäbisch hall', 'stuttgart', 'wetzlar'],
  ...
  Indonesia => [ 
    ...
    'palangka raya', 'palembang', 'palu', 'pariaman', 'pekanbaru', 'penajam', 
    'pontianak', 'riau', 'samarinda', 'secunderabad', 'semarang', 
...
(
  ...
  China => ['Beibao', 'Beidike', 'Beijing Capital', 'Beijing Cartoon', 
    ...
    'Meilin Qing Cheng', 'Nanfang Dianwang', 'Nanguang Power', 
