...
my @SINGLETON_LIST = qw(
  ...
  TEAM_MEET
  TEAM_DAY
  TEAM1_AGE TEAM2_AGE TEAM_AGE
  TEAM1_CAPTAIN TEAM2_CAPTAIN TEAM_CAPTAIN
  TEAM1_COUNTRY TEAM2_COUNTRY TEAM_COUNTRY
  TEAM1_REGION TEAM2_REGION TEAM_REGION
  TEAM1_CITY TEAM2_CITY TEAM_CITY
  TEAM1_GENDER TEAM2_GENDER TEAM_GENDER
  TEAM1_SPONSOR TEAM2_SPONSOR TEAM_SPONSOR
  TEAM1_ORDINAL TEAM2_ORDINAL TEAM_ORDINAL
  TEAM1_QUARTER TEAM2_QUARTER TEAM_QUARTER
  TEAM1_TWORD TEAM2_TWORD TEAM_TWORD
  Berth BERTH
  Day DAY
  DATE_START DATE_END
  Group GROUP
