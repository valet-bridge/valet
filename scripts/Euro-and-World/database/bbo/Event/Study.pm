...
(
  ...
  { START => 51674, END => 51689, TEXT => '^M-', CORR => 'Mixed Teams - ' },
  ...
  { START => 63740, END => 63797, TEXT => '^Gold ', 
    CORR => 'Indian Gold Open Teams ' },
  { START => 64042, END => 64101, TEXT => '^M-SW', 
    CORR => 'Mixed Teams - Swiss ' },
  { START => 64111, END => 64122, TEXT => '^M-R32-', 
    CORR => 'Mixed Teams - Rof32 - ' },
  { START => 64124, END => 64131, TEXT => '^M-R16-', 
    CORR => 'Mixed Teams - Rof16 - ' },
  { START => 64134, END => 64143, TEXT => '^M-QF', 
    CORR => 'Mixed Teams - QF ' },
  { START => 64146, END => 64167, TEXT => '^M-', 
    CORR => 'Mixed Teams - ' },
  ...
  { START => 68750, END => 68773, TEXT => '^ZC-R16-', 
    CORR => 'ZC - Rof16 - ' },
  ...
  { START => 77692, END => 77712, TEXT => '^Gold ', 
    CORR => 'Indian Gold Open Teams ' },
  { START => 78927, END => 78934, TEXT => '^OPEN R16-', 
    CORR => 'Open Teams - Rof16 - ' },
  { START => 79317, END => 79342, TEXT => 'SwR', CORR => 'Swiss - Round' },
  { START => 79346, END => 79362, TEXT => '^DR ', CORR => "RR " },
  { START => 79463, END => 79478, TEXT => '^MIXED R32-', 
    CORR => 'Mixed Teams - Rof32 - ' },
  { START => 79480, END => 79493, TEXT => '^MIXED R16-', 
    CORR => 'Mixed Teams - Rof16 - ' },
  { START => 79656, END => 79669, TEXT => '^OPEN R32-', 
    CORR => 'Open Teams - Rof32 - ' },
  { START => 79678, END => 79693, TEXT => '^OPEN R16-', 
    CORR => 'Open Teams - Rof16 - ' },
  ...
  { START => 83970, END => 84086, TEXT => '^M-', CORR => 'Mixed - ' },
...
(
  ...
  { START => 49193, END => 49249, TEXT => '^Match(\d)[ABC]$', 
    CORR => 'Match $1' },
  { START => 50630, END => 50670, TEXT => '^Q(\d)$', CORR => 'Segment $1' },
  { START => 50972, END => 51213, TEXT => '^Match (\d)[ABC]$', 
    CORR => 'Match $1' },
  ...
  { START => 55990, END => 56035, TEXT => '^Runde (\d+)-(\d)$', 
    CORR => 'Round $1 Segment $2' },
  ...
  { START => 60199, END => 60240, TEXT => '^(\d)-(\d)$', 
    CORR => '$1 of $2' },
  { START => 60860, END => 60931, TEXT => '^Match (\d)[ab]$', 
    CORR => 'Match $1' },
  ...
  { START => 61479, END => 61530, TEXT => '^Match(\d)[ABC]$', 
    CORR => 'Match $1' },
  { START => 62377, END => 62538, TEXT => '^(\d+)-(\d)$', 
    CORR => '$1 of $2' },
  { START => 62385, END => 62455, TEXT => '^Match (\d)[ABC] ', 
    CORR => 'Match $1 ' },
  ...
  { START => 67502, END => 67557, TEXT => '^(\d+)-(\d+)$', 
    CORR => '$1 of $2' },
  { START => 67737, END => 67847, TEXT => '^R(\d)[ABC]$', 
    CORR => 'Round $1' },
  ...
  { START => 73943, END => 74042, TEXT => 'Q *(\d) of 4$', 
    CORR => 'Quarter $1 of 4' },
  { START => 74170, END => 74218, TEXT => '^Kierros (\d)_(\d)$', 
    CORR => 'Round $1 - Segment $2' },
  ...
  { START => 82758, END => 82817, TEXT => '^(\d).. S$', 
    CORR => 'Segment $1' },
  { START => 82884, END => 82910, TEXT => '^R(\d+)_(\d)$', 
    CORR => 'Round $1 Segment $2' },
