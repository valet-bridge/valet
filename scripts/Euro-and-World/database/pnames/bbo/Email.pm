...
(
  ...
  '6egil ( egil@nerheim.nu' => [ EMAIL => 'egil@nerheim.nu', REST => 'Egil' ],
  '798686368 @.qq.com' => [ EMAIL => '798686368@qq.com' ],
  '88  @ yaman.com2breslau' => [ EMAIL => '88@yaman.com', CITY => 'Wroclaw' ],
  'abe@iki.fi, living in germany' => [ EMAIL => 'abe@iki.fi', COUNTRY => 'Germany' ],
  'ajay (28) bridgegoth@yahoo.fi' => [ EMAIL => 'bridgegoth@yahoo.fi', REST => 'Jay' ],
  ...
  'beniopszczola@o2.pl olsztyn' => [ EMAIL => 'beniopszczola@o2.pl', CITY => 'Olsztyn'],
  ...
  'fantoine: tonino947@hotmail.com' => [ EMAIL => 'tonino947@hotmail.com', 'REST' => 'Antoine' ],
  'fjarang dibelai jablaigtbc@y.co' => [ COUNTRY => 'Indonesia' ],
  'franmo@gmail.com junior' => [ EMAIL => 'franmo@gmail.com', REST => 'Junior' ],
  ...
  'giasmpierodionigiregione @alice.it' => [ COUNTRY => 'Italy', REST => 'Giampiero Dionigi' ],
  'gjs@autograf.pl  7725  kraków' => [ EMAIL => 'gjs@autograf.pl', CITY => 'Krakow' ],
  'gjay (29) bridgegoth@yahoo.fi' => [ EMAIL => 'bridgegoth@yahoo.fi', REST => 'Jay' ],
  'gosh59@abv.bg;sofia mladost1' => [ EMAIL => 'gosh59@abv.bg', CITY => 'Sofia' ],
  ...
  'jay (28) bridgegoth@yahoo.fi' => [ EMAIL => 'bridgegoth@yahoo.fi', REST => 'Jay' ],
  'jbm@mail.bg gusto maina' => [ EMAIL => 'jbm@mail.bg' ],
  'jemmabe@yahoo.fr (liege-belgium' => [ EMAIL => 'jemmabe@yahoo.fr', CITY => 'Liège'],
  'jglasspiegel @ol.com' => [ EMAIL => 'jglasspiegel@aol.com' ],
  'jmalawski@onet.pl 11153' => [ EMAIL => 'jmalawski@onet.pl' ],
  'kamal kumar naguri 1950@g mail . com' => [ EMAIL => 'naguri1950@gmail.com', REST => 'Kamal Kumar' ],
  ...
  'marisa.@ cantabria infinita' => [ REGION => 'Cantabria', REST => 'Marisa' ],
  ...
  'rreggi@wp.pl bydgoszcz' => [ EMAIL => 'rreggi@wp.pl', CITY => 'Bydgoszcz' ],
  'ruthacher@hotmail.com unusual nt' => [ EMAIL => 'ruthacher@hotmail.com' ],
  'sam aka showle@aol.com' => [ EMAIL => 'showle@aol.com', REST => 'Sam' ],
  ...
  'sneil-glm- timm@pitt.edu' => [ 'EMAIL' => '@timm@pitt.edu', REST => 'Neil TIMM', LEVEL => 'Life Master'],
  ...
  'syaloom tondano.@ com' => [ CITY => 'Tondano' ],
  'szekla23@vp.pl ilacy member' => [ EMAIL => 'szekla@wp.pl' ],
  'szunaj31@wp.pl pid-10500' => [ EMAIL => 'szunaj31@wp.pl' ],
  'tahir osman taos_tr@yahoo.com' => [ EMAIL => 'taos_tr@yahoo.com', REST => 'Tahir Osman' ],
  ...
  'vic sartor/vsartor77@aol.com' => [ EMAIL => 'vsartor77@aol.com', REST => 'Vic Sartor' ],
  'w.reszelski@o2.p 05348' => [ EMAIL => 'w.reszelski@o2.pl' ],
  'w.roj@wp.pl,pid 16248' => [ EMAIL => 'w.roj@wp.pl' ],
  'wojchr@op.pl warszawa' => [ EMAIL => 'wojchr@op.pl', CITY => 'Warsaw' ],
...
my @DOMAINS = qw(
  ag ar at au be bg biz br ca ch cl cn co com cz de dk edu ee eg es eu 
  fi fm fr gov gr hk hr hu id ie il is it in jp kr ku lt lu lv ma me mu mx 
  name net nl no nu nz org pl pt py ro ru se sg sk tn tr tw uk us yu za
);
