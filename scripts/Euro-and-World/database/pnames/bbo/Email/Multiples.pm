...
(
  ...
  'teomantoksoy@hotmail..com' => [ EMAIL => 'teomantoksoy@hotmail.com' ],
  'amurphy46@comcast..net' => [ EMAIL => 'amurphy46@comcast.net' ],
  'villeon@free..fr' => [ EMAIL => 'villeon@free.fr' ],
  'a.ziyabalci@hotmail..com' => [ EMAIL => 'a.ziyabalci@hotmail.com' ],
  'aca1joe@aol..com' => [ EMAIL => 'aca1joe@aol.com' ],
  'tonylenart@xtra.co..nz' => [ EMAIL => 'tonylenart@xtra.co.nz' ],
  'catriel.culham@g.mail.com' => [ EMAIL => 'catriel.culham@gmail.com' ],
  'ztz53@poczta.onet..pl' => [ EMAIL => 'ztz53@poczta.onet.pl' ],
  'neg=dbl/1nt@bbo.ro' => [ SYSTEM => 'neg=dbl/1nt', COUNTRY => 'Romania' ],

  'standod@ma[l.bg' => [ EMAIL => 'standod@mail.bg' ],
  'abural@(hotmail)(gmail).com' => [ EMAIL => 'abural@gmail.com'  ],
  'smoen53gmail@.com' => [ EMAIL => 'smoen53@gmail.com' ],
  'jefvande(@)kpnmail.nl' => [ EMAIL => 'jefvande@kpnmail.nl' ],
  'betty23@]wanadoo.fr' => [ EMAIL => 'betty23@wanadoo.fr' ],
  'krazykat[two]@pel.unm.edu' => [ EMAIL => 'krazykat@pel.unm.edu' ],
  'ronaldbarrie@{tesco.net' => [ EMAIL => 'ronaldbarrie@tesco.net' ],
  'lsg1955@aol,.com' => [ EMAIL => 'lsg1955@aol.com' ],
  'hzd_34@hotmai,l.com' => [ EMAIL => 'hzd_34@hotmail.com' ],
  'svmurtagh@~hotmail.com' => [ EMAIL => 'svmurtagh@hotmail.com' ],
  '249614404qq@.com' => [ EMAIL => '249614404@qq.com' ],
  'mglauck!@verizon.net' => [ EMAIL => 'mglauck1@verizon.net' ],
  'qq895937229@.com' => [ EMAIL => '895937229@qq.com' ],
  'snoopy1955supereva@.it' => [ EMAIL => 'snoopy1955@supereva.it' ],
  'timbolshaw+bbo@fastmail.fm' => [ EMAIL => 'timbolshaw@fastmail.fm' ],
  'jc0-9+lmick@sbcglobal.net' => [ EMAIL => 'jc0-9@sbcglobal.net' ],
  'piv+bbo@iki.fi' => [ EMAIL => 'piv@iki.fi' ],
  'lodos@.gmail.com' => [ EMAIL => 'lodos@gmail.com' ],
  'jcbrito!3@verizon.net' => [ EMAIL => 'jcbrito13@verizon.net' ],
  'kai.dahlenfjellbekk@.net' => [ EMAIL => 'kai.dahlen@fjellbekk.net' ],
  '979989318qq@.com' => [ EMAIL => '979989318@qq.com' ],
  'alipal@hfx,eastlink.ca' => [ EMAIL => 'alipal@hfx.eastlink.ca' ],
  'adampoplawski@poczta,onet.pl' => [ EMAIL => 'adampoplawski@poczta.onet.pl' ],
  ...
  'fethi17@hot.mail.com' => [ EMAIL => 'fethi17@hotmail.com' ],
  'sgopal@54gmail.com.in' => [ EMAIL => 'sgopal54@gmail.com.in' ],
  'knutmyg@online..no' => [ EMAIL => 'knutmyg@online.no' ],
  'ilse@ilsekuelsheimer.anadoo.com.uk' => [ EMAIL => 'ilsekuelsheimer@wanadoo.co.uk' ],
  'bbaceanu@yahoo.uk.co' => [ EMAIL => 'bbaceanu@yahoo.co.uk' ],
  'marlierjeanlouis@orange.fr' => [ EMAIL => 'marlierjeanlouis@orange.fr' ],
  'serdaroglunaci@hotmail.coml.com' => [ EMAIL => 'serdaroglunaci@hotmail.com' ],
  'ronly@012.met.il' => [ EMAIL => 'ronly@012.net.il' ],
  'gr@yahoo.ca.com' => [ EMAIL => 'gr@yahoo.ca' ],
  'asterisz@ath.fortnet.gr' => [ EMAIL => 'asterisz@ath.forthnet.gr' ],
  'lh691028@16..com' => [ EMAIL => 'lh691028@163.com' ],
  'hrongz@yaho..com' => [ EMAIL => 'hrongz@yahoo.com' ],
  'kovelamudijr@yahoo.c0.in' => [ EMAIL => 'kovelamudijr@yahoo.co.in' ],
  'novak@abv.bg.com' => [ EMAIL => 'novak@abv.bg' ],
  'bjorn.ahlm@comhem.nospam.se' => [ USER_ONE => 'Bjorn', USER_TWO => 'Ahlm', COUNTRY => 'Sweden' ],
  'ministre@impots.gouv.fr' => [ COUNTRY => 'France' ],
  'nevin.ergut@hoat.mail.com' => [ EMAIL => 'nevin.ergut@hotmail.com' ],
    'francoise;kron@gmail.com' => [ EMAIL => 'francoise.kron@gmail.com' ],
  'kopar102,@wp.pl' => [ EMAIL => 'kopar102@wp.pl' ],
  'mg=blokland@planet.nl' => [ EMAIL => 'mg.blokland@planet.nl' ],
